...
import { FileText, Target, Zap, TrendingUp, CheckCircle2, Award, ArrowRight, Star, BarChart3 } from "lucide-react";
  ...
  return (
    <PublicLayout>
      ...
      <section className="relative overflow-hidden py-20 md:py-28 lg:py-36 bg-background">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto text-center space-y-6 md:space-y-8 px-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
            <Button size="lg" asChild className="h-12 px-8 text-base font-semibold rounded-full shadow-lg shadow-primary/25 w-full sm:w-auto">
              <Link href="/register">
                {t("landing.ctaAnalyze")} <ArrowRight className="ms-2 h-4 w-4" />
              </Link>
            </Button>
            <Button size="lg" variant="outline" asChild className="h-12 px-8 text-base rounded-full w-full sm:w-auto">
        ...
        <div className="w-full max-w-screen-xl mx-auto px-4 md:px-10">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <Card key={step} className="bg-card border shadow-sm hover:shadow-md transition-shadow">
      ...
      <section className="py-20 md:py-28 bg-primary text-primary-foreground">
        <div className="w-full max-w-2xl mx-auto text-center space-y-6 px-4">
          <h2 className="text-3xl md:text-4xl font-extrabold">{t("landing.ctaAnalyze")}</h2>
          <p className="text-primary-foreground/75 text-lg">{t("landing.heroSubtitle")}</p>
          <Button size="lg" variant="secondary" asChild className="h-12 px-10 text-base font-semibold rounded-full shadow-xl">
            <Link href="/register">
              {t("landing.ctaAnalyze")} <ArrowRight className="ms-2 h-4 w-4" />
            </Link>
          </Button>
        ...
        <div className="w-full max-w-2xl mx-auto px-4">
          ...
          <Accordion type="single" collapsible className="w-full space-y-2">
            {([1, 2, 3] as const).map((n) => (
              <AccordionItem key={n} value={`item-${n}`} className="border rounded-xl px-5 shadow-sm bg-card">
