    ...
    <div className="min-h-[100dvh] flex flex-col bg-background selection:bg-primary selection:text-primary-foreground">
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between gap-4 px-4 md:px-8">
          ...
          {/* Logo */}
          <Link href="/" className="flex items-center gap-2.5 font-bold text-lg tracking-tight text-primary shrink-0">
            <span className="bg-primary text-primary-foreground px-2 py-0.5 rounded-md text-sm font-extrabold">AI</span>
            <span className="hidden sm:inline">{t("brand")}</span>
          </Link>

          {/* Desktop center nav */}
          <nav className="hidden md:flex items-center gap-0.5 bg-muted/50 rounded-full px-2 py-1">
      ...
      <footer className="border-t bg-muted/30">
        <div className="container px-4 md:px-10 py-12 md:py-16">
